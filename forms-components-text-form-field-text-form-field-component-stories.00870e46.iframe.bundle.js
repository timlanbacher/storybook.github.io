...
/* harmony default export */ const text_form_field_component_stories = ({
    ...
    decorators: [
        (0,dist.moduleMetadata)({
            declarations: [],
            imports: [input/* MatInputModule */.c, animations/* BrowserAnimationsModule */.PW, form_field/* MatFormFieldModule */.lN],
            providers: [],
        }),
    ],
});
...
//# sourceMappingURL=forms-components-text-form-field-text-form-field-component-stories.00870e46.iframe.bundle.js.map